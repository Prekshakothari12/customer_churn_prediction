...
contract = st.selectbox("Contract Type (Duration of customer agreement)", ["Month-to-month", "One year", "Two year"])
...
internet = st.selectbox("Internet Service (Type of internet connection)", ["DSL", "Fiber optic", "No"])
